...
class StudentTest(unittest.TestCase):
    ...
    def test_enroll_existing_course(self):
        ...
        self.assertEqual("Course already added. Notes have been updated.", result)
        self.assertEqual({"Python": ["n1", "n2", "n3", "n4", "n5", "n6","n7"], "JS": ["n1", "n2"]}, self.student_1.courses)

    def test_enroll_not_existing_course_with_y(self):
        result = self.student_1.enroll("C#" , ["n1", "n1"], "Y")
    ...
    def test_enroll_not_existing_course_with_empty_string(self):
        result = self.student_1.enroll("C#", ["n1", "n1"], "")
    ...
    def test_enroll_not_existing_course_not_adding_notes(self):
        result = self.student_1.enroll("C#", ["n1", "n1"], "N")
