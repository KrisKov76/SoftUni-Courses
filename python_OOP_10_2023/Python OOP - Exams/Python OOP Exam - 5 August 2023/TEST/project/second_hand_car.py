...
#
# test = SecondHandCar('Toyota', 'Sedan', 100000, 6000)
# test2 = SecondHandCar('Toyota', 'Sedan', 100000, 5000)
# print(test.set_promotional_price(2000))
# print(test.need_repair(100, 'смяна на фар'))
# a = test > test2
# print(test)
#
