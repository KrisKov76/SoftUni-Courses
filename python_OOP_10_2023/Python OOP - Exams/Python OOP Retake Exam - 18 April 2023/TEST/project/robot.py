...
robot = Robot('R1', 'Education', 200, 100)
robot2 = Robot('R2', 'Entertainment', 300, 100.99)
# print(robot.available_capacity)
# print(robot.upgrade("UPGRADE1", 100))
# print(robot.update(2.22, 50))
# print(robot.available_capacity)
# print(robot.update(2.22, 50))
# print(robot.available_capacity)
